...
<head>
  ...
  <link href="../../css/entrada-de-texto.css" rel="stylesheet" type="text/css">
</head>
...
<form id="mnt_form" class="" novalidate="" action="index.html">
  <div class="entradas-de-texto-govco">
    <label for="usu_nomape">Nombres y Apellidos*</label>
    <input type="text" id="usu_nomape" name="usu_nomape" placeholder="Ingresa tus nombres y apellidos"/>
    <span class="error-message" id="nombres-error">Ingresa tus nombres y apellidos</span>
  </div>
  
  <div class="entradas-de-texto-govco">
    <label for="usu_nit">Doc. Identidad*</label>
    <input type="number" class="input-basico-id" id="usu_nit" name="usu_nit" placeholder="Ingresa Documento de identidad" required="">
  ...
  <!-- De contraseña -->
    ...
    <div class="container-options-login-govco">
      ...
      <a class="mt-3" href="../../index.php">Acceder</a></p>
    </div>
  </div>
</div>
    ...
    <div class="govco-data-front">
      <div class="govco-footer-text">
        ...
        <div class="row col-xs-12 col-lg-7 govco-texto-sedes">
          ...
          <br>Correo institucional: <br> <a href="mailto:atencionalciudadano@palmira.gov.co">atencionalciudadano@palmira.gov.co</a><br><a href="mailto:ventanillaunica@palmira.gov.co">ventanillaunica@palmira.gov.co</a>&nbsp; &nbsp;</p><br class="govco-mostrar">
